...
window.copyItem = function(item, item2) {
let values = Object.values(item);
values.forEach((value, index) => {
setByIndex(item, index, byIndex(item2, index));
})
}
